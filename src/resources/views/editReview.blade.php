...
<form action="{{ route('editReview', ['shop_id' => $shop->id, 'review_id' => $review->id]) }}" method="POST" enctype="multipart/form-data" id="reviewForm">
    @csrf
    @method('PUT')
    <div class="review">
        ...
        <div class="review__right">
            ...
            <div class="review__right--input-review-wrapper">
                ...
                <div class="review__right--textarea">
                    <textarea name="comment" onkeyup="ShowLength(value)">{{ old('comment', $review->comment) }}</textarea>
