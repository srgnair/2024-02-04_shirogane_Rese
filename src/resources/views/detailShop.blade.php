...
<div class="container__shop-reserve">
    ...
    @if($existingReserve && $shop->reserves->first()->reserved_at <= \Carbon\Carbon::now() && !$existingReview) <div class="reserve">
...
@elseif($existingReserve && $shop->reserves->first()->reserved_at >= \Carbon\Carbon::now())
...
<div class="qrcode">
    <p>来店時は以下のQRコードを提示してください</p>
    {!! QrCode::generate(route('todayReserves')) !!}
</div>
