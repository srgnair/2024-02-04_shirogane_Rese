...
<div class="container__shop-reserve">
    <div class="shop">
        ...
        <div class="shop__review--wrapper">
            ...
            <div class="shop__review--image">
                @foreach ($review->images as $image)
                <img src="{{ asset('storage/' . $image->image_path) }}" alt="イメージ">
                @endforeach
            </div>
            <div class="shop__review--star">
                <div id="app">
                    <star-rating v-model="rating" :read-only="true" :star-size="20" active-color="#3f5fec"></star-rating>
                    <input type="hidden" id="star-rating-value" value="{{ $review->star }}" readonly>
                </div>
                <script src="https://cdnjs.cloudflare.com/ajax/libs/vue/2.6.10/vue.min.js"></script>
                <script src="https://unpkg.com/vue-star-rating/dist/VueStarRating.umd.min.js"></script>
                <script src="{{ asset('js/editStar.js') }}"></script>
            </div>
